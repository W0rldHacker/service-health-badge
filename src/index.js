...
export class ServiceHealthBadge extends HTMLElement {
  static get observedAttributes() {
    return ['endpoint', 'interval', 'timeout', 'labels', 'variant', 'show-latency', 'focusable'];
  }
  ...
  constructor() {
    ...
    this._root.innerHTML = `
      <style>
        ...
        /* Пользователи с повышенным контрастом */
  ...
  // ===== Публичные свойства (добавлено: focusable) =====
  get focusable() {
  ...
  // (остальные геттеры/сеттеры — как в E3.2; опущены ради краткости)
  get endpoint() {
